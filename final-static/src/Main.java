...
public class Main {
        ...
        public static void main(String[] args) {
            Car car1 = new Car("Toyota", "Camry", Car.BodyType.SEDAN, 2020, 30000);
            Car car2 = new Car("Honda", "Civic", Car.BodyType.SEDAN, 2021, 25000);
            ...
            Car newCar = new Car("Ford", "Mustang", Car.BodyType.COUPE, 2022, 45000);
